...
Mobile.tapAndHold(findTestObject('Object Repository/android.widget.LinearLayout (4)'), 0, 0)

Mobile.tap(findTestObject('Object Repository/android.widget.CheckedTextView - FedEx'), 0)
